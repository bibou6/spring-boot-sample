...
import com.ad.realestateengine.security.jwt.AuthEntryPointJwt;
import com.ad.realestateengine.security.jwt.AuthTokenFilter;
import com.ad.realestateengine.security.rules.SecurityRoles;
import com.ad.realestateengine.security.services.RestAccessDeniedHandler;
import com.ad.realestateengine.security.services.impl.UserDetailsServiceImpl;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable()
			...
			.antMatchers("/v1/user/*").hasAnyRole(SecurityRoles.ACCESS_MY_USER.name(), SecurityRoles.ACCESS_ALL_USER.name())
